            ...
            <div class="d-block d-md-flex align-items-center">
                <div>
                    <h1 class="display-6 fw-bold mb-5">
                        <?php ee('Create QR Codes <br>for {t}', null, ['t' => '<strong class="gradient-primary clip-text">Free</strong>']) ?>
                    </h1>
                </div>
            </div>
                    ...
                    <div class="flex-fill ms-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="border rounded p-2 shadow-sm mt-3 ms-3 d-none d-md-block">
                                ...
                                <span class="icon-md d-block rounded-circle mb-2 text-center mt-2"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="30" height="30" viewBox="0 0 30 30"><rect x="5" y="5" width="20" height="20" fill="#ffffff"></rect><g transform="scale(6)"><g transform="translate(-1,-15)"><path fill-rule="evenodd" d="M10 20M2 19C2 16 2 16 5 16M5 16C5 19 5 19 2 19" fill="#000000"/></g></g></svg></span>
