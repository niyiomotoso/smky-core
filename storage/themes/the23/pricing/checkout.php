            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="h-100 card border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <div class="my-3 btn-stack" data-bs-toggle="buttons">
                                <?php $i = 0; foreach($processors as $name => $processor): ?>
                                    <?php if(!config($name) || !config($name)->enabled) continue ?>
                                    <label class="btn py-3 px-4 <?php echo ($i == 0 ? 'active':'') ?>">
                                        <input type="radio" name="payment" class="d-none" value="<?php echo $name ?>" autocomplete="off" <?php echo ($i == 0 ? 'checked':'') ?>> <?php echo $processor['name'] ?>
                                    </label>
                                <?php $i++; endforeach ?>
                            </div>
                            <?php foreach($processors as $name => $processor): ?>
                                ...
                                <?php if($processor['checkout']): ?>
                                    <div class="my-4"><?php call_user_func($processor['checkout']) ?></div>
                                <?php endif ?>
                            <?php endforeach ?>
                            <h5 class="card-title fw-bold mt-5 mb-3"><?php ee('Billing Address') ?></h5>
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex w-100">
                        <a href="#redeemvoucher" class="text-dark ms-auto" data-bs-toggle="modal"><i class="fa fa-ticket-alt mr-2"></i> <?php ee('Redeem Voucher') ?></a>
                    </div>
                    <?php endif ?>
            ...
            <div class="modal-content">
                <form action="<?php echo route('checkout.redeem') ?>" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php ee('Redeem Voucher') ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <?php echo csrf() ?>
                        <div class="form-group mb-4">
                            <label class="form-label p-2 label"><?php ee('Voucher') ?></label>
