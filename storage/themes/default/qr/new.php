				...
				<div class="card-body collapse" id="colors">
                    ...
                    <div class="mb-3">
                        <div class="d-flex bg-light p-2 rounded-pill" data-toggle="multibuttons">
                            <a href="#singlecolor" class="btn flex-fill shadow-sm bg-white border rounded-pill fw-bold active" data-trigger="color" data-bs-parent="#colors"><?php ee('Single Color') ?></a>
