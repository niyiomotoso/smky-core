<form action="<?php echo route('qr.update', [$qr->id]) ?>" method="post" enctype="multipart/form-data">
    <div class="d-flex mb-5">
        <div>
            <h1 class="h3 mb-0"><?php ee('Edit QR') ?></h1>
        </div>
        <div class="ms-auto">
        ...
        <div class="col-md-7">
            ...
            <div class="card shadow-sm">
				...
				<div class="card-body collapse" id="colors">
                    ...
                    <div class="mb-3">
                        <div class="d-flex bg-light p-2 rounded-pill" data-toggle="multibuttons">
                            <a href="#singlecolor" class="btn flex-fill <?php echo isset($qr->data->color) ? 'shadow-sm bg-white border rounded-pill fw-bold active' : '' ?>" data-trigger="color" data-bs-parent="#colors"><?php ee('Single Color') ?></a>
                            <a href="#gradient" class="btn flex-fill <?php echo isset($qr->data->gradient) ? 'shadow-sm bg-white border rounded-pill flex-fill fw-bold' : '' ?>" data-trigger="color" data-bs-parent="#colors"><?php ee('Gradient Color') ?></a>
                        </div>
                    </div>
                    <?php endif ?>
