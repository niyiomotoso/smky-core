        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?php echo config("cookieconsent")->enabled ? '':'d-none' ?>">
                        <label for="cookieconsent[force]" class="form-label fw-bold"><?php ee('Enforce Cookie Consent') ?></label>
                        <div class="form-check form-switch">
                    ...
                    <div class="form-group">
                        <label for="publicqr" class="form-label fw-bold"><?php ee('Public QR Generator') ?></label>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" data-binary="true" id="publicqr" name="publicqr" value="1" <?php echo config("cookieconsent")->enabled ? 'checked':'' ?> data-toggle="togglefield">
                            <label class="form-check-label" for="publicqr"><?php ee('Enable') ?></label>
                        </div>
                        <p class="form-text"><?php ee('Enable this feature to allow the public to generate QR codes with limited features.') ?></p>
                    </div>
                    <hr>
                    <div class="form-group">
