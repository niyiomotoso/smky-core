...
<form action="<?php echo route('shorten') ?>" method="post" data-trigger="shorten-form" enctype="multipart/form-data">
    ...
    <div class="d-flex mt-4">
        <div class="btn-group ms-auto">
            <button type="button" class="btn btn-secondary btn-sm active" data-bs-toggle="collapse" data-trigger="toggleSM" data-value="single" data-bs-target="#single"><?php ee('Single') ?></button>
            <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="collapse" data-trigger="toggleSM" data-value="multiple" data-bs-target="#multiple"><?php ee('Multiple') ?></button>
        </div>
    </div>
            ...
            <div class="collapse mt-4 border p-3 rounded-3" id="deeplink">
                <div class="form-group d-flex align-items-center">
                    ...
                    <div class="form-check form-switch ms-auto">
                        <input class="form-check-input" type="checkbox" data-binary="true" id="deeplink[enabled]" name="deeplink[enabled]" value="1" data-toggle="togglefield" data-toggle-for="deelinkapple,deelinkgoogle">
                    </div>
                </div>
