...
// Homepage
Gem::get($prefix.'/', 'Home@index')->name('home')->middleware('CheckDomain')->middleware('CheckMaintenance')->middleware('CheckPrivate');
...
// Terms Page
Gem::get($prefix.'/terms', 'Page@terms')->name('terms')->middleware('CheckDomain')->middleware('CheckPrivate');
...
Gem::group($prefix.'/user', function(){
    ...
    Gem::post('/updateonlinestatus', 'Users@updateLastTimeOnline')->middleware('CheckDomain')->name('updateLastTimeOnline');
